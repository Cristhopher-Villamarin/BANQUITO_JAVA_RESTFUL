...
public class ElectrodomesticoEditar extends javax.swing.JFrame {
    ...
    // Constructor por defecto (por si lo abres directo para pruebas)
    ...
    private void guardarCambios() {
        ...
        try {
            controller.actualizarElectrodomestico(idElectrodomestico, nombre, precio);
            JOptionPane.showMessageDialog(this,
